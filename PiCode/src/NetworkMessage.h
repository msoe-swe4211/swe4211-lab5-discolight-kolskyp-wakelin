...
struct networkMessageStruct {
	/**
	 * This is a flag for the security mode.  Overall, it is 0 unless the message is encrypted in some format.  If it is non zero, then some form of encryption is being used.
	 */
	...
	/**
	 * This is the first parameter for the message.
	 */
	int32_t parameter1;

	/**
	 * This is the second parameter for the message.
	 */
	int32_t parameter2;
